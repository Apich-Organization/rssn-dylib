// File: benches/numerical\transforms.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::transforms module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\TRANSFORMS ---
    let mut group = c.benchmark_group("numerical\transforms");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::transforms::some_function(black_box(10)));
        })
    });
