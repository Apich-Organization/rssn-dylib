// File: benches/numerical\sparse.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::sparse module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\SPARSE ---
    let mut group = c.benchmark_group("numerical\sparse");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::sparse::some_function(black_box(10)));
        })
    });
