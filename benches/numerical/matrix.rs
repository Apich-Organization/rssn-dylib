// File: benches/numerical\matrix.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::matrix module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\MATRIX ---
    let mut group = c.benchmark_group("numerical\matrix");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::matrix::some_function(black_box(10)));
        })
    });
