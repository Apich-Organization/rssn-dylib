// File: benches/numerical\multi_valued.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::multi_valued module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\MULTI_VALUED ---
    let mut group = c.benchmark_group("numerical\multi_valued");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::multi_valued::some_function(black_box(10)));
        })
    });
