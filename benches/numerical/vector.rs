// File: benches/numerical\vector.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::vector module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\VECTOR ---
    let mut group = c.benchmark_group("numerical\vector");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::vector::some_function(black_box(10)));
        })
    });
