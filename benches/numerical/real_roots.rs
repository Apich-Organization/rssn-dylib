// File: benches/numerical\real_roots.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::real_roots module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\REAL_ROOTS ---
    let mut group = c.benchmark_group("numerical\real_roots");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::real_roots::some_function(black_box(10)));
        })
    });
