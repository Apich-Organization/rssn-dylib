// File: benches/numerical\coordinates.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::coordinates module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\COORDINATES ---
    let mut group = c.benchmark_group("numerical\coordinates");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::coordinates::some_function(black_box(10)));
        })
    });
