// File: benches/numerical\special.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::special module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\SPECIAL ---
    let mut group = c.benchmark_group("numerical\special");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::special::some_function(black_box(10)));
        })
    });
