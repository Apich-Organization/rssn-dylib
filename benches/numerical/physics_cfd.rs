// File: benches/numerical\physics_cfd.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::physics_cfd module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\PHYSICS_CFD ---
    let mut group = c.benchmark_group("numerical\physics_cfd");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::physics_cfd::some_function(black_box(10)));
        })
    });
