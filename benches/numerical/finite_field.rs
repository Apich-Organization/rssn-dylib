// File: benches/numerical\finite_field.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::finite_field module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\FINITE_FIELD ---
    let mut group = c.benchmark_group("numerical\finite_field");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::finite_field::some_function(black_box(10)));
        })
    });
