// File: benches/numerical\convergence.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::convergence module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\CONVERGENCE ---
    let mut group = c.benchmark_group("numerical\convergence");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::convergence::some_function(black_box(10)));
        })
    });
