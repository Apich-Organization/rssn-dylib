// File: benches/numerical\pde.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::pde module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\PDE ---
    let mut group = c.benchmark_group("numerical\pde");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::pde::some_function(black_box(10)));
        })
    });
