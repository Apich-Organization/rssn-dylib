// File: benches/numerical\signal.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::signal module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\SIGNAL ---
    let mut group = c.benchmark_group("numerical\signal");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::signal::some_function(black_box(10)));
        })
    });
