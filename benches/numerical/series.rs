// File: benches/numerical\series.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::series module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\SERIES ---
    let mut group = c.benchmark_group("numerical\series");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::series::some_function(black_box(10)));
        })
    });
