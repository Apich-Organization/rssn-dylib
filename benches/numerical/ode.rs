// File: benches/numerical\ode.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::ode module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\ODE ---
    let mut group = c.benchmark_group("numerical\ode");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::ode::some_function(black_box(10)));
        })
    });
