// File: benches/numerical\elementary.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the numerical::elementary module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: NUMERICAL\ELEMENTARY ---
    let mut group = c.benchmark_group("numerical\elementary");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(numerical::elementary::some_function(black_box(10)));
        })
    });
