// File: benches/physics\physics_sim\gpe_superfluidity.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_sim::gpe_superfluidity module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_SIM\GPE_SUPERFLUIDITY ---
    let mut group = c.benchmark_group("physics\physics_sim\gpe_superfluidity");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_sim::gpe_superfluidity::some_function(black_box(10)));
        })
    });
