// File: benches/physics\physics_sim\fdtd_electrodynamics.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_sim::fdtd_electrodynamics module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_SIM\FDTD_ELECTRODYNAMICS ---
    let mut group = c.benchmark_group("physics\physics_sim\fdtd_electrodynamics");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_sim::fdtd_electrodynamics::some_function(black_box(10)));
        })
    });
