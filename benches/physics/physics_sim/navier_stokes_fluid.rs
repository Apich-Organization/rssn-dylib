// File: benches/physics\physics_sim\navier_stokes_fluid.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_sim::navier_stokes_fluid module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_SIM\NAVIER_STOKES_FLUID ---
    let mut group = c.benchmark_group("physics\physics_sim\navier_stokes_fluid");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_sim::navier_stokes_fluid::some_function(black_box(10)));
        })
    });
