// File: benches/physics\physics_sm.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_sm module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_SM ---
    let mut group = c.benchmark_group("physics\physics_sm");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_sm::some_function(black_box(10)));
        })
    });
