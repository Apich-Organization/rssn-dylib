// File: benches/physics\physics_mtm.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_mtm module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_MTM ---
    let mut group = c.benchmark_group("physics\physics_mtm");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_mtm::some_function(black_box(10)));
        })
    });
