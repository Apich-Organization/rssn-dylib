// File: benches/physics\physics_em.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_em module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_EM ---
    let mut group = c.benchmark_group("physics\physics_em");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_em::some_function(black_box(10)));
        })
    });
