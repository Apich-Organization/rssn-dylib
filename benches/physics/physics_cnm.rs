// File: benches/physics\physics_cnm.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_cnm module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_CNM ---
    let mut group = c.benchmark_group("physics\physics_cnm");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_cnm::some_function(black_box(10)));
        })
    });
