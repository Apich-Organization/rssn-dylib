// File: benches/physics\physics_fdm.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the physics::physics_fdm module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: PHYSICS\PHYSICS_FDM ---
    let mut group = c.benchmark_group("physics\physics_fdm");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(physics::physics_fdm::some_function(black_box(10)));
        })
    });
