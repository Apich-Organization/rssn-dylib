// File: benches/output\typst.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the output::typst module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: OUTPUT\TYPST ---
    let mut group = c.benchmark_group("output\typst");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(output::typst::some_function(black_box(10)));
        })
    });
