// File: benches/output\latex.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the output::latex module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: OUTPUT\LATEX ---
    let mut group = c.benchmark_group("output\latex");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(output::latex::some_function(black_box(10)));
        })
    });
