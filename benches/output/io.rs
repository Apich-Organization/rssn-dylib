// File: benches/output\io.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the output::io module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: OUTPUT\IO ---
    let mut group = c.benchmark_group("output\io");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(output::io::some_function(black_box(10)));
        })
    });
