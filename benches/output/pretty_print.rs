// File: benches/output\pretty_print.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the output::pretty_print module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: OUTPUT\PRETTY_PRINT ---
    let mut group = c.benchmark_group("output\pretty_print");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(output::pretty_print::some_function(black_box(10)));
        })
    });
