// File: benches/output\mod.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the output::mod module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: OUTPUT\MOD ---
    let mut group = c.benchmark_group("output\mod");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(output::mod::some_function(black_box(10)));
        })
    });
