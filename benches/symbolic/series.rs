// File: benches/symbolic\series.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the symbolic::series module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: SYMBOLIC\SERIES ---
    let mut group = c.benchmark_group("symbolic\series");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(symbolic::series::some_function(black_box(10)));
        })
    });
