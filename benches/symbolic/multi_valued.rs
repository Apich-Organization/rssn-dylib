// File: benches/symbolic\multi_valued.rs
//
// Criterion Benchmarks for the 'rssn' crate's public API in the symbolic::multi_valued module.
//
...
pub fn criterion_benchmark(c: &mut Criterion) {
    // --- BENCHMARK GROUP: SYMBOLIC\MULTI_VALUED ---
    let mut group = c.benchmark_group("symbolic\multi_valued");
    ...
    group.bench_function("function_name_small_input", |b| {
        b.iter(|| {
            ...
            // black_box(symbolic::multi_valued::some_function(black_box(10)));
        })
    });
