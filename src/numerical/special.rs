...
pub fn bessel_j0(x: f64) -> f64 {
    ...
    if ax < 8.0 {
        ...
        let ans1 = 57_568_490_574.0
            + y * (-13_362_590_354.0
                + y * (651_619_640.7 + y * y.mul_add(y.mul_add(-184.905_245_6, 77_392.330_17), -11_214_424.18)));
...
pub fn bessel_j1(x: f64) -> f64 {
    ...
    if ax < 8.0 {
        ...
        let ans1 = x
            * (723_626_142_320.0
                + y * (-789_505_923_500.0
                    + y * (242_396_853.1 + y * y.mul_add(y.mul_add(-30.160_366_06, 15_704.482_60), -2_972_611.439))));
...
pub fn bessel_y0(x: f64) -> f64 {
    ...
    if x < 8.0 {
        ...
        let ans1 = -2_957_821_389.0
            + y * (7_062_834_065.0
                + y * (-512_359_803.6 + y * y.mul_add(y.mul_add(228.462_273_3, -86_327.927_57), 10_879_881.29)));
            ...
            * (-49_006_049_430_000_000.0
                + y * (12_752_743_900_000_000.0
                    + y * (-5_153_438_139_000.0
                        + y * y.mul_add(y.mul_add(85_119_379.35, -42_379_227.26), 7_349_264_551.0))));
