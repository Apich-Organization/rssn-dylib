...
impl Multivector3D {
    ...
    pub fn norm_sq(self) -> f64 {
        ...
        self.v2.mul_add(self.v2, self.s.mul_add(
            self.s,
            self.v1 * self.v1,
        ))
            + self.v3 * self.v3
    ...
    pub fn wedge(
        ...
        Self {
            ...
            b31: self.v3.mul_add(rhs.v1, self.s.mul_add(
                ...
                - self.v1 * rhs.v3,
            pss: self.v2.mul_add(rhs.b31, self.v1.mul_add(
                rhs.b23,
                self.s.mul_add(
                    rhs.pss,
                    self.pss * rhs.s,
    ...
    pub fn dot(
        ...
        // A . B = sum_{r,s} <<a>_r <b>_s>_{|r-s|}
        Self {
            s: self.v3.mul_add(rhs.v3, self.v2.mul_add(
                rhs.v2,
                self.s.mul_add(
                    rhs.s,
                    self.v1 * rhs.v1,
            ...
            v1: self.v2.mul_add(-rhs.b12, self.s.mul_add(
                ...
                - self.b23 * rhs.pss
                - self.pss * rhs.b23,
            v2: self.v2.mul_add(rhs.s, self.s.mul_add(
                rhs.v2,
                self.v1 * rhs.b12,
            ))
                - self.v3 * rhs.b23
                ...
                - self.b31 * rhs.pss
                - self.pss * rhs.b31,
            v3: self.v2.mul_add(rhs.b23, self.s.mul_add(
                rhs.v3,
                -(self.v1 * rhs.b31),
            ))
                + self.v3 * rhs.s
                ...
                + self.b31 * rhs.v1
                - self.pss * rhs.b12,
            b12: self.b23.mul_add(-rhs.b31, self.s.mul_add(
                rhs.b12,
                self.b12 * rhs.s,
            ))
                + self.b31 * rhs.b23,
            b23: self.b12.mul_add(rhs.b31, self.s.mul_add(
                rhs.b23,
                self.b23 * rhs.s,
            ))
                - self.b31 * rhs.b12,
            b31: self.b12.mul_add(-rhs.b23, self.s.mul_add(
                rhs.b31,
                self.b31 * rhs.s,
            ))
                + self.b23 * rhs.b12,
    ...
    fn mul(
        ...
        Self {
            s: self.v3.mul_add(rhs.v3, self.v2.mul_add(
                ...
                - self.b31 * rhs.b31
                - self.pss * rhs.pss,
            v1: self.v3.mul_add(rhs.b31, self.v2.mul_add(
                -rhs.b12,
                self.s.mul_add(
                    rhs.v1,
                    self.v1 * rhs.s,
                ...
                - self.b23 * rhs.pss
                - self.pss * rhs.b23,
            v2: self.v3.mul_add(-rhs.b23, self.v1.mul_add(
                rhs.b12,
                self.s.mul_add(
                    rhs.v2,
                    self.v2 * rhs.s,
                ...
                - self.b31 * rhs.pss
                - self.pss * rhs.b31,
            v3: self.v2.mul_add(rhs.b23, self.v1.mul_add(
                -rhs.b31,
                self.s.mul_add(
                    rhs.v3,
                    self.v3 * rhs.s,
                ...
                - self.b12 * rhs.pss
                - self.pss * rhs.b12,
            b12: self.v2.mul_add(-rhs.v1, self.v1.mul_add(
                rhs.v2,
                self.s.mul_add(
                    rhs.b12,
                    self.b12 * rhs.s,
                ...
                - self.b23 * rhs.b31
                + self.b31 * rhs.b23,
            b23: self.v3.mul_add(-rhs.v2, self.v2.mul_add(
                rhs.v3,
                self.s.mul_add(
                    rhs.b23,
                    self.b23 * rhs.s,
                ...
                - self.b31 * rhs.b12
                + self.b12 * rhs.b31,
            b31: self.v1.mul_add(-rhs.v3, self.v3.mul_add(
                rhs.v1,
                self.s.mul_add(
                    rhs.b31,
                    self.b31 * rhs.s,
