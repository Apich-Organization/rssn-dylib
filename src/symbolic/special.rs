...
pub fn bessel_j0(x: f64) -> f64 {
    ...
    if ax < 8.0 {
        ...
        let ans1 = 57_568_490_411.0
            + y * y.mul_add(y.mul_add(y.mul_add(y.mul_add(
                            -184_905_245_600.0,
                            77_392_330_170.0,
                        ), -11_214_424.18), 651_619_640.7), -13_362_590_354.0);
        ...
        let ans1 = x
            * (72_362_614_232.0
                + y * y.mul_add(y.mul_add(y.mul_add(y.mul_add(
                                -30.160_366_06,
                                15_704.482_60,
                            ), -2_972_611.439), 242_396_853.1), -7_895_059_235.0));
    ...
    if x < 8.0 {
        ...
        let ans1 = -2_957_821_389.0
            + y * y.mul_add(y.mul_add(y.mul_add(y.mul_add(
                            228.462_273_3,
                            -86_327.927_57,
                        ), 10_879_881.29), -512_359_803.6), 7_062_834_065.0);
    ...
    if x < 8.0 {
        ...
        let ans1 = x
            * (-4_900_604_943_000.0
                + y * y.mul_add(y.mul_add(y.mul_add(y.mul_add(
                                8_511.937_935,
                                -4_237_922.726,
                            ), 734_926_455.1), -51_534_381_390.0), 1_275_274_390_000.0));
        ...
        let ans2 = 24_909_857_500_000.0
            + y * y.mul_add(y.mul_add(y.mul_add(
                        ...
                        22_459_040.02,
                    ), 3_733_650_367.0), 4_244_419_664_000.0);
